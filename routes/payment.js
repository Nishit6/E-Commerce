...
router.post('/payment_gateway/payumoney',isAuthorized, (req, res) => {
...
router.post('/payment/success',isAuthorized, async(req, res) => {
...
router.post('/payment/fail',isAuthorized, (req, res) => {
